...
class Conversation(Base):
    ...
    settings = Column(FlexJSON, nullable=True)  # Custom settings
...
class ConversationParticipant(Base):
    ...
    last_read_message_id = Column(GUID(), ForeignKey("messages.id"), nullable=True)
    ...
    is_archived = Column(Boolean, nullable=False, default=False)
    notification_settings = Column(FlexJSON, nullable=True)
...
class Message(Base):
    ...
    # Optional metadata
    metadata = Column(FlexJSON, nullable=True)  # Dice rolls, images, attachments, etc.
    
    # Attachments
    attachment_urls = Column(FlexJSON, nullable=True)  # List of URLs
